...
import { signIn, signUp } from '@/lib/logto';
...
const navigation = [
  ...
  { name: 'Demandes de dons', href: '/requests' },
            ...
            <div className="hidden items-center lg:flex lg:flex-1 lg:justify-end">
              ...
              {!isAuthenticated ? (
                <>
                  <Button
                    onClick={signIn}
                    className="mr-2 rounded-md bg-rose-600 shadow-sm hover:bg-rose-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-600"
                  >
                    Se connecter
                  </Button>
                ...
                <Link href="/profile" className="text-sm font-semibold leading-6 text-gray-900">
                  Mon profile <span aria-hidden="true">&rarr;</span>
                </Link>
              )}
            </div>
          </nav>
